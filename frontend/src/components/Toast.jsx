...
const Toast = ({ toast, onClose }) => {
  ...
  return (
    <div
      className={`flex w-full min-w-0 items-start gap-3 rounded-lg border p-3 shadow-lg transition-all duration-300 sm:min-w-[280px] sm:max-w-md sm:p-4 ${        styles[type] || styles.info
      }`}
